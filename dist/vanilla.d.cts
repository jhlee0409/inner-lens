 ...
 */
declare const HOSTED_API_ENDPOINT = "https://inner-lens-one.vercel.app/api/report";
/**
 * Maximum number of log entries to keep
 * Used consistently across Core, Hosted API, and Self-hosted server
 */
declare const MAX_LOG_ENTRIES = 50;
/**
...
declare global {
    interface Window {
        InnerLens?: typeof InnerLensCore;
        innerLensConfig?: InnerLensCoreConfig;
    }
}
