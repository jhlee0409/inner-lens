...
var NavigationEntrySchema = z.object({
  type: z.enum([
    "pageload",
    "pushstate",
    "replacestate",
...
var PerformanceSummarySchema = z.object({
...
var BugReportSchema = z.object({
  description: z.string().min(1, "Description is required").max(1e4),
  logs: z.array(
    z.object({
...
export { BugReportSchema, createExpressHandler, createFastifyHandler, createFetchHandler, createGitHubIssue, createKoaHandler, createNodeHandler, createReportHandler, handleBugReport, maskSensitiveData, maskSensitiveObject, validateBugReport };
